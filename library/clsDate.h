...
class clsDate
{
  ...
  public:
    ...
    //         int DiffBetweenTwoDates ( clsDate date1 , bool including = false ){
    //
    //        int diff =0;
    //        while ((*this).IsDateLessThanDate2(date1)){
    //
    ...
    //}
    //
    //          int DiffBetweenTwoDates(clsDate d1 , clsDate d2, bool including = false) {
    //                clsDate date1 = d1;
    //                clsDate date2 = d2;
    //
    //                int diff = 0;
    ...
    //                }
    //
    //                while (clsDate::IsDate1LessThanDate2(date1, date2)) {
    ...
    //        static int DiffBetweenTwoDates (clsDate date1 , clsDate date2 , bool including = false ){
    //
    //            return date1.DiffBetweenTwoDates(dat
...
class clsDate
{
  ...
  public:
    ...
    //        static int DiffBetweenTwoDates (clsDate date1 , clsDate date2 , bool including = false ){
    //
    //            return date1.DiffBetweenTwoDates(date2);
    //        }

    //        int DayOfBirth (clsDate birthday ){
    //
    //            return birthday.DiffBetweenTwoDates((*this), birthday );
    //        }
